...
public class OdometryGlobalCoordinatePosition implements Runnable{
     ...
     */
    public OdometryGlobalCoordinatePosition(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay, double startingPositionX, double startingPositionY, double startingOrientation ){
